...
Continual learning studies systems that learn from a sequence of tasks while retaining earlier capabilities~\cite{buzzega2020dark,wang2022learning,wang2022dualprompt}. Domain and test-time adaptation address distribution shift~\cite{ben-david2010da,ganin2016dann,wang2021tent,liang2020shot}, and mixture-of-experts methods route heterogeneous inputs to specialised components~\cite{jacobs1991moe,shazeer2017moe}. These directions cover pieces of our D1--D3 setting, but they usually adapt model weights, classifiers, or expert modules. We study the harness-level analogue: prompts, skills, tools, memory, and infrastructure must be constructed from accumulated trajectories and selected for each incoming task.
