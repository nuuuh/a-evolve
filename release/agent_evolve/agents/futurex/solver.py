...
def solve_one(task_data: Dict[str, Any], args_dict: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        model_id = args_dict.get("model_id", "<solver-model-id>")
        ...
        _wiki_session.headers.update({
            "User-Agent": "AdaptiveAutoHarness/0.1 (temporal-prediction-benchmark) python-requests"
        })
