...
- Create specialized branches EARLY for distinct task domains you observe.
- Main should contain general-purpose tools. Branches specialize prompts/skills.
- When you see 3+ tasks from the same domain failing similarly, that's a branch signal.
- Do not rewrite prompts/system.md from scratch — make targeted additions.
- If tools/skills work, preserve them. Only add, don't remove.
