...
echo ""
echo "Analysis:"
echo "  python evaluations/analysis_poly/analyze_all.py --db data/polymarket_analysis.db"
echo "  python evaluations/analysis_ctf/analyze_all.py  --catalog data/ctf_archive.json"
