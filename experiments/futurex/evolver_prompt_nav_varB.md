...
- NEVER remove or rewrite working tools or prompts. Only ADD new content.
- If a tool exists and passes basic tests, it stays. Add new tools alongside it.
- Keep prompts/system.md changes to APPENDING new sections, not rewriting existing ones.
- Memory updates: only append new learnings, never delete prior entries.
